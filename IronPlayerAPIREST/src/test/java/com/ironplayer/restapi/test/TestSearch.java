...
public class TestSearch {
	...
	public void test() {
		...
		try {
			InputStream in = TestSearch.class.getResourceAsStream("/" + PROPERTIES_FILENAME);
			properties.load(in);
		...
		try {
			...
			if (searchResultList != null) {
				prettyPrint(searchResultList.iterator(), queryTerm,properties.getProperty("youtube.url"));
			}
	 ...
	 */
	private static void prettyPrint(Iterator<SearchResult> iteratorSearchResults, String query,String youtubeUrl) {
